...
import type { AccountId, AccountIndex, Address, Balance, BlockNumber, Call, ChangesTrieConfiguration, KeyValue, LookupSource, Moment, Perbill, Weight } from '@polkadot/types/interfaces/runtime';
import type { Key } from '@polkadot/types/interfaces/system';
import type { KittyIndex } from 'kitty-workshop/interfaces/kitties';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    kitties: {
       ...
       * Breed kitties
       **/
      breed: AugmentedSubmittable<(kittyId1: KittyIndex | AnyNumber | Uint8Array, kittyId2: KittyIndex | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [KittyIndex, KittyIndex]>;
      /**
       * Create a new kitty
       **/
       ...
       **/
      transfer: AugmentedSubmittable<(to: AccountId | string | Uint8Array, kittyId: KittyIndex | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, KittyIndex]>;
    };
    sudo: {
      /**
