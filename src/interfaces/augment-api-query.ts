...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    kitties: {
       ...
       **/
      kitties: AugmentedQueryDoubleMap<ApiType, (key1: AccountId | string | Uint8Array, key2: KittyIndex | AnyNumber | Uint8Array) => Observable<Option<Kitty>>, [AccountId, KittyIndex]>;
      /**
       * Stores the next kitty ID
       **/
      nextKittyId: AugmentedQuery<ApiType, () => Observable<KittyIndex>, []>;
    };
